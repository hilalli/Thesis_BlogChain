            ...
            <article className="best-post">
              <div
                ...
                style={{ // değişmeyecek 2024 vıdeo games
                  backgroundImage: `url("https://kinsta.com/wp-content/uploads/2019/12/how-to-start-a-fashion-blog.jpg")`,
              ...
              <div className="best-post-content">
                ...
                <div className="best-post-content-title" style={{color:"black"}}>Newest Blogs!</div>
                <div className="best-post-content-sub">
                  This website present a revolutionary platform with blockchain
                  technology and the SOL token. We offer users the opportunity
                  to posting.
                </div>
              ...
              {posts.map((item) => {
                return (
                  ...
                  >
                    <div className="post__card_-2 ">
                      <div
                        ...
                        style={{ // post ön yüz ilk değişmesi gereken
                          backgroundImage: `url("https://m.bidolubaski.com/sites/default/files/content_files/creativebloq-tasarimcilarin-takip-etmesi_gereken-bloglar.jpg")`,
                        }}
                      ></div>
                      <div>
                    ...
                    <div className="post__card_meta-2m p-4" style={{ display: 'inline-block', marginRight: '10px' }} ></div>
                  ...
                  >
                    <div className="post__card_-2 ">
                      <div
                        className="post__card__image-2"
                        style={{ // post ön yüz ilk değişmesi gereken
                          backgroundImage: `url("https://ontariobusinessgrants.com/wp-content/uploads/2023/04/How-to-Start-a-Blog-in-Canada.png")`,
                        }}
                      ></div>
                      <div>
                        <div className="post__card_meta-2  gap-4 p-3">
                          <div className="post__card_cat flex">
                          Business Idea: grsgsrgrsgrgrdgsgs <span className="dot"> </span>
